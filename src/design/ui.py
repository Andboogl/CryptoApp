...
"}")
        ...
        self.background.setGeometry(QtCore.QRect(0, 0, 831, 561))
        ...
        self.frame.setGeometry(QtCore.QRect(10, 10, 271, 531))
...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("src/icons/hash.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("src/icons/file.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.about_application.setGeometry(QtCore.QRect(10, 370, 251, 71))
        font = QtGui.QFont()
        font.setPointSize(15)
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("src/icons/dandruff.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.exit_out.setGeometry(QtCore.QRect(10, 450, 251, 71))
        font = QtGui.QFont()
        font.setPointSize(15)
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("src/icons/exit.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("src/icons/decrypt.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(290, 20, 511, 471))
...
"padding-left: 10px;")
        ...
        self.hash_encrypt_algorithm.setStyleSheet("")
...
"}")
        ...
        self.file_to_encrypt_password_encrypt.setStyleSheet("")
...
"padding-left: 10px;")
        ...
        self.decrypt_file_password_algorithm.setStyleSheet("")
...
"}")
        ...
        self.label_14.setPixmap(QtGui.QPixmap("src/icons/author_logo.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_12.setText(_translate("MainWindow", "Версія 0.0.0"))
